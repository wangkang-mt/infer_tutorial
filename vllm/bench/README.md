...
bash vllm_bench_with_gpu.sh \
    ...
    --gpu-num 8
```
- 如果不指定--served-model-name，默认基于模型路径自动生成，如：Qwen3-32B
...
## 4.1 实时解析
可实时可视化监控各测试项性能，用于探索性能，同时**提供log 及 测试结果下载功能**
```shell
...
<img width="2506" height="1135" alt="69ff8b608622e7ce18c5fb35f77e986e" src="https://github.com/user-attachments/assets/119d5c95-9701-40f9-83e8-aff40163946f" />
